...
public class LPiece {
    ...
    public static void resetAndCheck(){
        Board.board[block1y][block1x] = 7;
        Board.board[block2y][block2x] = 7;
        Board.board[block3y][block3x] = 7;
        Board.board[block4y][block4x] = 7;
    ...
    public static void renderLPiece(){
    ...
    public static void moveDown(){
        placeLBlock();
        if(rotationState == 0){
            if(block4y < 19 && Board.board[block2y + 1][block2x] < 1 && Board.board[block4y + 1][block4x] < 1 && Board.board[block3y + 1][block3x] < 1){
                shiftDown();
            }
        } else if(rotationState == 1){
    ...
    public static void moveLeft(){
        if(rotationState == 0){
            ...
            if(block4x > 0 && Board.board[block2y][block2x - 1] < 1 && Board.board[block3y][block3x - 1] < 1 && Board.board[block4y][block4x - 1] < 1){
                shiftLeft();
            }
        } else if (rotationState == 2){
            if(block3x > 0 && Board.board[block3y][block3x - 1] < 1 && Board.board[block4y][block4x - 1] < 1){
                shiftLeft();
            }
        } else if (rotationState == 3){
    ...
    public static void placeLBlock() {
        if(rotationState == 0){
            if (block4y == 19 || Board.board[block2y + 1][block2x] > 1 || Board.board[block4y + 1][block4x] > 1 || Board.board[block3y + 1][block3x] > 1) {
                resetAndCheck();
            }
